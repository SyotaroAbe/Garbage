...
HRESULT CPlayer::Init(D3DXVECTOR3 pos)
{
	...
	for (int nCntModel = 0; nCntModel < m_nNumModel; nCntModel++)
	{
		...
		D3DXVECTOR3 pos = CGame::GetLoad()->GetPos(nCntModel);					// 位置の取得
		D3DXVECTOR3 rot = CGame::GetLoad()->GetRot(nCntModel);					// 向きの取得
	...
	{
		int nParent = CGame::GetLoad()->GetParent(nCntModel);	// 親を取得
